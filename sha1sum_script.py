...
def update_proprietary_files(file_path, base_dir):
    updated_lines = []
    try:
        with open(file_path, 'r') as f:
            for line in f:
                ...
                if line and not line.startswith('#'):
                    ...
                    absolute_path = os.path.abspath(os.path.join(base_dir, search_path))
                    ...
                    if os.path.isfile(absolute_path):
                        ...
                        print(f"File not found for search: {search_path}")
                        updated_lines.append(line)
                else:
                    updated_lines.append(line)
...
def main():
    ...
    update_proprietary_files(proprietary_files_path, base_path)
